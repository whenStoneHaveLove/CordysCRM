 ...
 * 主状态流转另写 ad_order_log。响应由框架 {@code ResultResponseBodyAdvice} 统一包裹（包路径 cn.cordys）。</p>
 *
 * <p>鉴权：由 {@link AdPaymentRecordService} 依据 {@code ROLE_FINANCE} 做角色级守卫（同 M2/M3 风格），
 * 未接入 ad 专用权限常量（M6 收口）。</p>
 */
@Tag(name = "广告收付款（财务中心）")
@RestController

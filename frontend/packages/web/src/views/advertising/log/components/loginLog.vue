<template>
  <CrmCard no-content-bottom-padding hide-footer :special-height="160">
    <CrmTable
      ref="crmTableRef"
      v-bind="propsRes"
      class="crm-ad-login-log-table"
...
<script setup lang="ts">
  ...
  const { propsRes, propsEvent, loadList, setLoadListParams } = useTable(loginLogList, {
    ...
    hiddenRefresh: true,
    containerClass: '.crm-ad-login-log-table',
  });

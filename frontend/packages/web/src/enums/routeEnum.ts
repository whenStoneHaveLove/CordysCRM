...
export enum AdvertisingRouteEnum {
  ...
  ADVERTISING_RESOURCE = 'advertisingResource',
  ADVERTISING_RESOURCE_CREATE = 'advertisingResourceCreate',
  ADVERTISING_RESOURCE_EDIT = 'advertisingResourceEdit',
  ADVERTISING_RESOURCE_DETAIL = 'advertisingResourceDetail',

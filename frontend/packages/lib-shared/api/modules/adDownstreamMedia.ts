...
import { AdDownstreamMediaPageUrl, AdDownstreamMediaUrl } from '@lib/shared/api/requrls/adDownstreamMedia';
...
export interface AdDownstreamMediaDetail {
  media?: AdDownstreamMediaItem;
  statusLabel?: string;
  cooperationStatusLabel?: string;
  mediaTypeLabel?: string;
  businessEntityName?: string;
